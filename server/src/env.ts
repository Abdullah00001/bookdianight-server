...
export const env: TEnv = {
  ...
  JWT_RESET_PASSWORD_TOKEN_SECRET_KEY: getEnv(
    'JWT_RESET_PASSWORD_TOKEN_SECRET_KEY'
  ),
  STRIPE_SECRET_KEY: getEnv('STRIPE_SECRET_KEY'),
  STRIPE_PAYMENT_WEBHOOK_SECRET_KEY: getEnv(
    'STRIPE_PAYMENT_WEBHOOK_SECRET_KEY'
  ),
  STRIPE_CONNECT_WEBHOOK_SECRET_KEY: getEnv(
    'STRIPE_CONNECT_WEBHOOK_SECRET_KEY'
  ),
  STRIPE_CONNECT_PUBLIC_BASE_URL: getEnv('STRIPE_CONNECT_PUBLIC_BASE_URL'),
  FLUTTER_CONNECT_APP_LINK_URL: getEnv('FLUTTER_CONNECT_APP_LINK_URL'),
};
