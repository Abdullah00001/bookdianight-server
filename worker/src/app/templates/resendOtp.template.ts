          ...
          <tr>
            <td style="padding:32px 32px 8px 32px;">
              ...
              <p style="margin:0 0 6px 0; color:#b3b3bd; font-size:15px; line-height:1.6;">
                Hi <strong style="color:#ffffff;">{{name}}</strong>, we received a request for a new verification code.
              </p>
              <p style="margin:0 0 20px 0; color:#b3b3bd; font-size:15px; line-height:1.6;">
                Use the code below to verify <strong style="color:#ffffff;">{{email}}</strong>. Your previous code is no longer valid.
              </p>
            </td>
          </tr>
